...
<ComClass(BlockNum_AddAnno.ClassId, BlockNum_AddAnno.InterfaceId, BlockNum_AddAnno.EventsId), _
 ProgId("SanGISMaintenanceToolbar.BlockNum_AddAnno")> _
Public NotInheritable Class BlockNum_AddAnno
    Inherits BaseTool
...
#Region "COM GUIDs"
    ...
    Public Const ClassId As String = "08581667-c5cd-476b-bfe1-a89554074766"
    Public Const InterfaceId As String = "4273ec0b-28bc-4305-80d5-dfff0862937a"
    Public Const EventsId As String = "339e9d62-5d40-438c-aec7-efdf7c44cb9e"
#End Region
...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.m_caption = "BlockNum"   'localizable text 
        MyBase.m_message = "Add BlockNum Anno"   'localizable text 
        MyBase.m_toolTip = "Add BlockNum Anno" 'localizable text 
        MyBase.m_name = "SanGISMaintenanceToolbar_BlockNum_AddAnno"  'unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
    ...
    Public Overrides Sub OnClick()
        'TODO: Add BlockNum_AddAnno.OnClick implementation
    End Sub
    ...
    Public Overrides Sub OnMouseDown(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Integer, ByVal Y As Integer)
        Try
            ...
            If ipBox.ShowDialog("Enter BlockNum", "BlockNum: ", "BLK ", txtinput, False, pScreenPoint) = Windows.Forms.DialogResult.Cancel Then
                ' Cancel Pressed
                Exit Sub
            End If
            ...
            If pFLayer Is Nothing Then
                MsgBox("Parcel layer not found. Please add it to the map before trying to annotate blocknum")
                Exit Sub
            End If
            pFWorkspace = pFLayer.FeatureClass.FeatureDataset.Workspace
            '------------------------------------------
            'Get the anno featureclass from workspace
            pFeatClass = pFWorkspace.OpenFeatureClass(Anno_BLOCKNO_DATASRC)
            ...
            pGroupSymbolElement.SymbolID = 1
            pGroupSymbolElement.Size = 47.52
    ...
    Public Overrides Sub OnMouseMove(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Integer, ByVal Y As Integer)
        'TODO: Add BlockNum_AddAnno.OnMouseMove implementation
    End Sub

    Public Overrides Sub OnMouseUp(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Integer, ByVal Y As Integer)
        'TODO: Add BlockNum_AddAnno.OnMouseUp implementation
    End Sub
