...
<ComClass(TentMap_AddAnno.ClassId, TentMap_AddAnno.InterfaceId, TentMap_AddAnno.EventsId), _
 ProgId("SanGISMaintenanceToolbar.TentMap_AddAnno")> _
Public NotInheritable Class TentMap_AddAnno
    Inherits BaseTool
...
#Region "COM GUIDs"
    ...
    Public Const ClassId As String = "99ad1122-2c5e-4e21-b725-7c8f5deeee5b"
    Public Const InterfaceId As String = "d91f2128-ee33-4b07-9fba-9ba65c723081"
    Public Const EventsId As String = "21e008ec-f181-440c-a775-fb4fdbc4bcb9"
#End Region
...
#End Region
    ...
    Public Sub New()
        ...
        MyBase.m_caption = "TentMap"   'localizable text 
        MyBase.m_message = "Add TentMap Anno"   'localizable text 
        MyBase.m_toolTip = "Add TentMap Anno" 'localizable text 
        MyBase.m_name = "SanGISMaintenanceToolbar_TentMap_AddAnno"  'unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
    ...
    Public Overrides Sub OnClick()
        'TODO: Add TentMap_AddAnno.OnClick implementation
    End Sub
    ...
    Public Overrides Sub OnMouseDown(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Integer, ByVal Y As Integer)
        Try
            ...
            If ipBox.ShowDialog("Enter TentMap", "TentMap: ", "", txtinput, False, pScreenPoint) = Windows.Forms.DialogResult.Cancel Then
                ' Cancel Pressed
                Exit Sub
            End If
            ...
            pFeatClass = pFWorkspace.OpenFeatureClass(Anno_TENTMAP_DATASRC)
    ...
    Public Overrides Sub OnMouseMove(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Integer, ByVal Y As Integer)
        'TODO: Add TentMap_AddAnno.OnMouseMove implementation
    End Sub

    Public Overrides Sub OnMouseUp(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Integer, ByVal Y As Integer)
        'TODO: Add TentMap_AddAnno.OnMouseUp implementation
    End Sub
